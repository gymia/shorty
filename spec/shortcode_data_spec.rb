  ...
  context 'Model' do
    context 'invalid' do
      it 'is not valid if shortcode too short' do
        ...
        code.validate
        expect(code.errors.full_messages).to include(ShortcodeData::ERROR_MSG_REGEXP)
      end
      ...
      it 'is not valid if url is missing' do
        ...
        code.validate
        expect(code.errors.full_messages).to include(ShortcodeData::ERROR_MSG_URL)
      end
    end
    ...
    context 'valid' do
      ...
      it 'should generate valid shortcode of exactly 6 chars if non was given' do
        code = ShortcodeData.create(url: 'http://www.google.com')
